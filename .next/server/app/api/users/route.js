(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[701],{2067:t=>{"use strict";t.exports=require("node:async_hooks")},6195:t=>{"use strict";t.exports=require("node:buffer")},3643:(t,e,r)=>{"use strict";r.r(e),r.d(e,{ComponentMod:()=>O,default:()=>p});var a={};r.r(a),r.d(a,{GET:()=>u,POST:()=>o,runtime:()=>_});var i={};r.r(i),r.d(i,{originalPathname:()=>A,patchFetch:()=>I,requestAsyncStorage:()=>l,routeModule:()=>R,serverHooks:()=>N,staticGenerationAsyncStorage:()=>T});var s=r(8842),d=r(2561),n=r(4828),E=r(6631),c=r(1213);let _="edge";async function u(t){try{let{searchParams:e}=new URL(t.url),r=e.get("discordId"),a=e.get("active");if(r){let t=await (0,c.PR)(r);return Response.json({success:!0,user:t})}if("true"!==a)return Response.json({success:!1,error:"Missing parameters"},{status:400});{let t=await (0,c.cO)();return Response.json({success:!0,users:t})}}catch(t){return console.error("GET users error:",t),Response.json({success:!1,error:t.message},{status:500})}}async function o(t){try{let{discordId:e,discordUsername:r,callsign:a,vehicle:i}=await t.json();if(!e)return Response.json({success:!1,error:"Missing discordId"},{status:400});let s=await (0,c.kX)(e,r||"",a||"",i||"");return Response.json({success:!0,user:s})}catch(t){return console.error("POST user error:",t),Response.json({success:!1,error:t.message},{status:500})}}let R=new d.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/users/route",pathname:"/api/users",filename:"route",bundlePath:"app/api/users/route"},resolvedPagePath:"C:\\Users\\Toby\\Downloads\\node-v24.11.1-win-x64\\app123\\app\\api\\users\\route.js",nextConfigOutput:"",userland:a}),{requestAsyncStorage:l,staticGenerationAsyncStorage:T,serverHooks:N}=R,A="/api/users/route";function I(){return(0,E.XH)({serverHooks:N,staticGenerationAsyncStorage:T})}let O=i,p=s.a.wrap(R)},1213:(t,e,r)=>{"use strict";r.d(e,{$h:()=>E,AW:()=>O,F3:()=>_,Fs:()=>I,HX:()=>c,J3:()=>n,PR:()=>N,Qr:()=>S,Y0:()=>o,cO:()=>T,ie:()=>d,kX:()=>l,mG:()=>p,qx:()=>A,wK:()=>R,wX:()=>u,xN:()=>s});var a=r(1989);function i(){if(!process.env.DATABASE_URL)throw Error("DATABASE_URL environment variable is not set");return(0,a.qn)(process.env.DATABASE_URL)}async function s(){let t=i();return await t`
  ...
  `)[0]||null}async function E(t,e){let r=i();return(await r`
    ...
    WHERE incident_id = ${t} AND patient_letter = ${e}
    RETURNING *
  `)[0]}async function c(t,e){let r=i();return await r`
  ...
  `,(await r`
    ...
    RETURNING *
  `)[0]||null}async function _(t,e,r,a){let s=i();return(await s`
    UPDATE eprf_records 
  ...
  `)[0]||null}async function A(t,e,r,a,s){let d=i();return r&&"all"!==r?e?await d`
        SELECT * FROM eprf_records 
      ...
      `:await d`
        ...
        WHERE author_discord_id = ${t}
        ORDER BY created_at DESC
      `}async function I(t,e,r){let a=i();return r&&e&&"all"!==e?t?await a`
      ...
      `:await a`
        ...
        LEFT JOIN users u ON r.author_discord_id = u.discord_id
        ORDER BY r.created_at DESC
      `}async function O(){let t=i();return await t`
    SELECT * FROM users 
    ORDER BY last_login DESC
  `}async function p(t,e){let r=i();return await r`
    DELETE FROM eprf_data 
    WHERE incident_id = ${t} AND patient_letter = ${e}
  `,(await r`
    DELETE FROM eprf_records 
  ...
  `)[0]||null}async function S(t,e,r){let a=i();return(await a`
    ...
    WHERE incident_id = ${t} AND patient_letter = ${e}
    RETURNING *
  `)[0]}}},t=>{var e=e=>t(t.s=e);t.O(0,[378,112],()=>e(3643));var r=t.O();(_ENTRIES="undefined"==typeof _ENTRIES?{}:_ENTRIES)["middleware_app/api/users/route"]=r}]);
